...
typedef enum {
    SCROLLBAR_NEVER,
    SCROLLBAR_ON_SCROLLED,
    SCROLLBAR_ON_HOVERED,
    SCROLLBAR_ON_SCROLL_AND_HOVER,
    SCROLLBAR_ON_SCROLL_OR_HOVER,
    SCROLLBAR_ALWAYS
...
typedef enum { PADDING_FILL_BACKGROUND, PADDING_FILL_NEIGHBORING_CELL } PaddingFillStrategy;
