...
vert_t(Canvas *self, uint base_char, uint variation) {
    ...
    half_hline(self, m[1], base_char != U'┤', 0);
...
horz_t(Canvas *self, uint base_char, uint variation) {
    ...
    half_hline(self, m[0], false, 0);
    half_hline(self, m[1], true, 0);
    half_vline(self, m[2], base_char != U'┴', 0);
}
...
#define S(ch, func, ...) SS(ch, func(c, __VA_ARGS__))
    ...
    switch (ch) {
        ...
        case U'█':
            ...
            C(U'╴', half_hline, 1, false, 0);
            C(U'╵', half_vline, 1, false, 0);
            C(U'╶', half_hline, 1, true, 0);
            C(U'╷', half_vline, 1, true, 0);
            C(U'╸', half_hline, 3, false, 0);
            C(U'╹', half_vline, 3, false, 0);
            C(U'╺', half_hline, 3, true, 0);
            C(U'╻', half_vline, 3, true, 0);
            CC(U'╾', half_hline(c, 3, false, 0); half_hline(c, 1, true, 0));
            CC(U'╼', half_hline(c, 1, false, 0); half_hline(c, 3, true, 0));
            CC(U'╿', half_vline(c, 3, false, 0); half_vline(c, 1, true, 0));
            CC(U'╽', half_vline(c, 1, false, 0); half_vline(c, 3, true, 0));

            S(U'', triangle, true, false);
            S(U'', triangle, true, true);
            SS(U'', half_cross_line(c, 1, TOP_LEFT); half_cross_line(c, 1, BOTTOM_LEFT));
            S(U'', triangle, false, false);
            S(U'', triangle, false, true);
            SS(U'', half_cross_line(c, 1, TOP_RIGHT); half_cross_line(c, 1, BOTTOM_RIGHT));

            S(U'', filled_D, true);
            S(U'◗', filled_D, true);
            S(U'', filled_D, false);
            S(U'◖', filled_D, false);
            C(U'', rounded_separator, 1, true);
            C(U'', rounded_separator, 1, false);

            S(U'', cross_line, 1, true);
            S(U'', cross_line, 1, true);
            S(U'╲', cross_line, 1, true);
            S(U'', cross_line, 1, false);
            S(U'', cross_line, 1, false);
            S(U'╱', cross_line, 1, false);
            SS(U'╳', cross_line(c, 1, false); cross_line(c, 1, true));

            S(U'', corner_triangle, BOTTOM_LEFT);
            S(U'◣', corner_triangle, BOTTOM_LEFT);
            S(U'', corner_triangle, BOTTOM_RIGHT);
            S(U'◢', corner_triangle, BOTTOM_RIGHT);
            S(U'', corner_triangle, TOP_LEFT);
            S(U'◤', corner_triangle, TOP_LEFT);
            S(U'', corner_triangle, TOP_RIGHT);
            S(U'◥', corner_triangle, TOP_RIGHT);

            C(U'', progress_bar, LEFT, false);
            C(U'', progress_bar, MIDDLE, false);
            C(U'', progress_bar, RIGHT, false);
            C(U'', progress_bar, LEFT, true);
            C(U'', progress_bar, MIDDLE, true);
            C(U'', progress_bar, RIGHT, true);

            C(U'', spinner, 1, 235, 305);
            C(U'', spinner, 1, 270, 390);
            C(U'', spinner, 1, 315, 470);
            C(U'', spinner, 1, 360, 540);
            C(U'', spinner, 1, 80, 220);
            C(U'', spinner, 1, 170, 270);
            C(U'○', spinner, 0, 0, 360);
            C(U'◜', spinner, 1, 180, 270);
            C(U'◝', spinner, 1, 270, 360);
            C(U'◞', spinner, 1, 360, 450);
            C(U'◟', spinner, 1, 450, 540);
            C(U'◠', spinner, 1, 180, 360);
            C(U'◡', spinner, 1, 0, 180);
            S(U'●', fill_circle, 1.0, 0, false);
            S(U'◉', draw_fish_eye, 0);

            C(U'═', dhline, 1, TOP_EDGE | BOTTOM_EDGE);
            C(U'║', dvline, 1, LEFT_EDGE | RIGHT_EDGE);
            CC(U'╞', vline(c, 1); half_dhline(c, 1, true, TOP_EDGE | BOTTOM_EDGE));
            CC(U'╡', vline(c, 1); half_dhline(c, 1, false, TOP_EDGE | BOTTOM_EDGE));
            CC(U'╥', hline(c, 1); half_dvline(c, 1, true, LEFT_EDGE | RIGHT_EDGE));
            CC(U'╨', hline(c, 1); half_dvline(c, 1, false, LEFT_EDGE | RIGHT_EDGE));
            CC(U'╪', vline(c, 1); dhline(c, 1, TOP_EDGE | BOTTOM_EDGE));
            CC(U'╫', hline(c, 1), dvline(c, 1, LEFT_EDGE | RIGHT_EDGE));
            CC(U'╬', inner_corner(c, 1, TOP_LEFT); inner_corner(c, 1, TOP_RIGHT); inner_corner(c, 1, BOTTOM_LEFT); inner_corner(c, 1, BOTTOM_RIGHT));
            CC(U'╠', inner_corner(c, 1, TOP_RIGHT); inner_corner(c, 1, BOTTOM_RIGHT); dvline(c, 1, LEFT_EDGE));
            CC(U'╣', inner_corner(c, 1, TOP_LEFT); inner_corner(c, 1, BOTTOM_LEFT); dvline(c, 1, RIGHT_EDGE));
            CC(U'╦', inner_corner(c, 1, BOTTOM_LEFT); inner_corner(c, 1, BOTTOM_RIGHT); dhline(c, 1, TOP_EDGE));
            CC(U'╩', inner_corner(c, 1, TOP_LEFT); inner_corner(c, 1, TOP_RIGHT); dhline(c, 1, BOTTOM_EDGE));
...
#define SH(ch, ...) C(ch, shade, (Shade){__VA_ARGS__});
            SH(U'░', .xnum = 12, .light = true);
            SH(U'▒', .xnum = 12);
            SH(U'▓', .xnum = 12, .light = true, .invert = true);
            SH(U'🮌', .xnum = 12, .which_half = LEFT_EDGE);
            SH(U'🮍', .xnum = 12, .which_half = RIGHT_EDGE);
            SH(U'🮎', .xnum = 12, .which_half = TOP_EDGE);
            SH(U'🮏', .xnum = 12, .which_half = BOTTOM_EDGE);
            SH(U'🮐', .xnum = 12, .invert = true);
            SH(U'🮑', .xnum = 12, .invert = true, .fill_blank = true, .which_half = BOTTOM_EDGE);
            SH(U'🮒', .xnum = 12, .invert = true, .fill_blank = true, .which_half = TOP_EDGE);
            SH(U'🮓', .xnum = 12, .invert = true, .fill_blank = true, .which_half = RIGHT_EDGE);
            SH(U'🮔', .xnum = 12, .invert = true, .fill_blank = true, .which_half = LEFT_EDGE);
            SH(U'🮕', .xnum = 4, .ynum = 4);
            SH(U'🮖', .xnum = 4, .ynum = 4, .invert = true);
            SH(U'🮗', .xnum = 1, .ynum = 4, .invert = true);
#define M(ch, corner)                                                                    \
...
#undef M
#undef SH
            S(U'🮘', cross_shade, false);
            S(U'🮙', cross_shade, true);

            C(U'▖', quad, BOTTOM_LEFT);
            C(U'▗', quad, BOTTOM_RIGHT);
            C(U'▘', quad, TOP_LEFT);
            C(U'▝', quad, TOP_RIGHT);
            C(U'▙', quads, TOP_LEFT, BOTTOM_LEFT, BOTTOM_RIGHT, 0);
            C(U'▚', quads, TOP_LEFT, BOTTOM_RIGHT, 0);
            C(U'▛', quads, TOP_LEFT, TOP_RIGHT, BOTTOM_LEFT, 0);
            C(U'▜', quads, TOP_LEFT, TOP_RIGHT, BOTTOM_RIGHT, 0);
            C(U'▞', quads, TOP_RIGHT, BOTTOM_LEFT, 0);
            C(U'▟', quads, TOP_RIGHT, BOTTOM_LEFT, BOTTOM_RIGHT, 0);

            S(U'🬼', smooth_mosaic, true, 0, 2. / 3, 0.5, 1);
            S(U'🬽', smooth_mosaic, true, 0, 2. / 3, 1, 1);
            S(U'🬾', smooth_mosaic, true, 0, 1. / 3, 0.5, 1);
            S(U'🬿', smooth_mosaic, true, 0, 1. / 3, 1, 1);
            S(U'🭀', smooth_mosaic, true, 0, 0, 0.5, 1);

            S(U'🭁', smooth_mosaic, true, 0, 1. / 3, 0.5, 0);
            S(U'🭂', smooth_mosaic, true, 0, 1. / 3, 1, 0);
            S(U'🭃', smooth_mosaic, true, 0, 2. / 3, 0.5, 0);
            S(U'🭄', smooth_mosaic, true, 0, 2. / 3, 1, 0);
            S(U'🭅', smooth_mosaic, true, 0, 1, 0.5, 0);
            S(U'🭆', smooth_mosaic, true, 0, 2. / 3, 1, 1. / 3);

            S(U'🭇', smooth_mosaic, true, 0.5, 1, 1, 2. / 3);
            S(U'🭈', smooth_mosaic, true, 0, 1, 1, 2. / 3);
            S(U'🭉', smooth_mosaic, true, 0.5, 1, 1, 1. / 3);
            S(U'🭊', smooth_mosaic, true, 0, 1, 1, 1. / 3);
            S(U'🭋', smooth_mosaic, true, 0.5, 1, 1, 0);

            S(U'🭌', smooth_mosaic, true, 0.5, 0, 1, 1. / 3);
            S(U'🭍', smooth_mosaic, true, 0, 0, 1, 1. / 3);
            S(U'🭎', smooth_mosaic, true, 0.5, 0, 1, 2. / 3);
            S(U'🭏', smooth_mosaic, true, 0, 0, 1, 2. / 3);
            S(U'🭐', smooth_mosaic, true, 0.5, 0, 1, 1);
            S(U'🭑', smooth_mosaic, true, 0, 1. / 3, 1, 2. / 3);

            S(U'🭒', smooth_mosaic, false, 0, 2. / 3, 0.5, 1);
            S(U'🭓', smooth_mosaic, false, 0, 2. / 3, 1, 1);
            S(U'🭔', smooth_mosaic, false, 0, 1. / 3, 0.5, 1);
            S(U'🭕', smooth_mosaic, false, 0, 1. / 3, 1, 1);
            S(U'🭖', smooth_mosaic, false, 0, 0, 0.5, 1);

            S(U'🭗', smooth_mosaic, false, 0, 1. / 3, 0.5, 0);
            S(U'🭘', smooth_mosaic, false, 0, 1. / 3, 1, 0);
            S(U'🭙', smooth_mosaic, false, 0, 2. / 3, 0.5, 0);
            S(U'🭚', smooth_mosaic, false, 0, 2. / 3, 1, 0);
            S(U'🭛', smooth_mosaic, false, 0, 1, 0.5, 0);

            S(U'🭜', smooth_mosaic, false, 0, 2. / 3, 1, 1. / 3);
            S(U'🭝', smooth_mosaic, false, 0.5, 1, 1, 2. / 3);
            S(U'🭞', smooth_mosaic, false, 0, 1, 1, 2. / 3);
            S(U'🭟', smooth_mosaic, false, 0.5, 1, 1, 1. / 3);
            S(U'🭠', smooth_mosaic, false, 0, 1, 1, 1. / 3);
            S(U'🭡', smooth_mosaic, false, 0.5, 1, 1, 0);

            S(U'🭢', smooth_mosaic, false, 0.5, 0, 1, 1. / 3);
            S(U'🭣', smooth_mosaic, false, 0, 0, 1, 1. / 3);
            S(U'🭤', smooth_mosaic, false, 0.5, 0, 1, 2. / 3);
            S(U'🭥', smooth_mosaic, false, 0, 0, 1, 2. / 3);
            S(U'🭦', smooth_mosaic, false, 0.5, 0, 1, 1);
            S(U'🭧', smooth_mosaic, false, 0, 1. / 3, 1, 2. / 3);

            S(U'🭨', half_triangle, LEFT_EDGE, true);
            S(U'🭩', half_triangle, TOP_EDGE, true);
            S(U'🭪', half_triangle, RIGHT_EDGE, true);
            S(U'🭫', half_triangle, BOTTOM_EDGE, true);
            S(U'🭬', half_triangle, LEFT_EDGE, false);
            SS(U'🮛', half_triangle(c, LEFT_EDGE, false), half_triangle(c, RIGHT_EDGE, false));
            S(U'🭭', half_triangle, TOP_EDGE, false);
            S(U'🭮', half_triangle, RIGHT_EDGE, false);
            S(U'🭯', half_triangle, BOTTOM_EDGE, false);
            SS(U'🮚', half_triangle(c, BOTTOM_EDGE, false), half_triangle(c, TOP_EDGE, false));

            CC(U'🭼', eight_bar(c, 0, false); eight_bar(c, 7, true));
            CC(U'🭽', eight_bar(c, 0, false); eight_bar(c, 0, true));
            CC(U'🭾', eight_bar(c, 7, false); eight_bar(c, 0, true));
            CC(U'🭿', eight_bar(c, 7, false); eight_bar(c, 7, true));
            CC(U'🮀', eight_bar(c, 0, true); eight_bar(c, 7, true));
            CC(U'🮁', eight_bar(c, 0, true); eight_bar(c, 2, true); eight_bar(c, 4, true); eight_bar(c, 7, true));

            C(U'🮂', eight_block, true, 0, 1, -1);
            C(U'🮃', eight_block, true, 0, 1, 2, -1);
            C(U'🮄', eight_block, true, 0, 1, 2, 3, 4, -1);
            C(U'🮅', eight_block, true, 0, 1, 2, 3, 4, 5, -1);
            C(U'🮆', eight_block, true, 0, 1, 2, 3, 4, 5, 6, -1);
            C(U'🮇', eight_block, false, 6, 7, -1);
            C(U'🮈', eight_block, false, 5, 6, 7, -1);
            C(U'🮉', eight_block, false, 3, 4, 5, 6, 7, -1);
            C(U'🮊', eight_block, false, 2, 3, 4, 5, 6, 7, -1);
            C(U'🮋', eight_block, false, 1, 2, 3, 4, 5, 6, 7, -1);

            S(U'🮠', mid_lines, 1, TOP_LEFT, 0);
            S(U'🮡', mid_lines, 1, TOP_RIGHT, 0);
            S(U'🮢', mid_lines, 1, BOTTOM_LEFT, 0);
            S(U'🮣', mid_lines, 1, BOTTOM_RIGHT, 0);
            S(U'🮤', mid_lines, 1, TOP_LEFT, BOTTOM_LEFT, 0);
            S(U'🮥', mid_lines, 1, TOP_RIGHT, BOTTOM_RIGHT, 0);
            S(U'🮦', mid_lines, 1, BOTTOM_RIGHT, BOTTOM_LEFT, 0);
            S(U'🮧', mid_lines, 1, TOP_RIGHT, TOP_LEFT, 0);
            S(U'🮨', mid_lines, 1, BOTTOM_RIGHT, TOP_LEFT, 0);
            S(U'🮩', mid_lines, 1, BOTTOM_LEFT, TOP_RIGHT, 0);
            S(U'🮪', mid_lines, 1, BOTTOM_LEFT, TOP_RIGHT, BOTTOM_RIGHT, 0);
            S(U'🮫', mid_lines, 1, BOTTOM_LEFT, TOP_LEFT, BOTTOM_RIGHT, 0);
            S(U'🮬', mid_lines, 1, TOP_RIGHT, TOP_LEFT, BOTTOM_RIGHT, 0);
            S(U'🮭', mid_lines, 1, TOP_RIGHT, TOP_LEFT, BOTTOM_LEFT, 0);
            S(U'🮮', mid_lines, 1, TOP_RIGHT, BOTTOM_RIGHT, TOP_LEFT, BOTTOM_LEFT, 0);

            C(U'', hline, 1);
            C(U'', vline, 1);
            C(U'', fading_hline, 1, 4, RIGHT_EDGE);
            C(U'', fading_hline, 1, 4, LEFT_EDGE);
            C(U'', fading_vline, 1, 5, BOTTOM_EDGE);
            C(U'', fading_vline, 1, 5, TOP_EDGE);

            C(U'', rounded_corner, 1, TOP_LEFT);
            C(U'', rounded_corner, 1, TOP_RIGHT);
            C(U'', rounded_corner, 1, BOTTOM_LEFT);
            C(U'', rounded_corner, 1, BOTTOM_RIGHT);

            CC(U'', vline(c, 1); rounded_corner(c, 1, BOTTOM_LEFT));
            CC(U'', vline(c, 1); rounded_corner(c, 1, TOP_LEFT));
            CC(U'', rounded_corner(c, 1, BOTTOM_LEFT), rounded_corner(c, 1, TOP_LEFT));
            CC(U'', vline(c, 1); rounded_corner(c, 1, BOTTOM_RIGHT));
            CC(U'', vline(c, 1); rounded_corner(c, 1, TOP_RIGHT));
            CC(U'', rounded_corner(c, 1, TOP_RIGHT), rounded_corner(c, 1, BOTTOM_RIGHT));
            CC(U'', hline(c, 1); rounded_corner(c, 1, TOP_RIGHT));
            CC(U'', hline(c, 1); rounded_corner(c, 1, TOP_LEFT));
            CC(U'', rounded_corner(c, 1, TOP_LEFT), rounded_corner(c, 1, TOP_RIGHT));
            CC(U'', hline(c, 1); rounded_corner(c, 1, BOTTOM_RIGHT));
            CC(U'', hline(c, 1); rounded_corner(c, 1, BOTTOM_LEFT));
            CC(U'', rounded_corner(c, 1, BOTTOM_LEFT), rounded_corner(c, 1, BOTTOM_RIGHT));
            CC(U'', vline(c, 1); rounded_corner(c, 1, BOTTOM_LEFT), rounded_corner(c, 1, BOTTOM_RIGHT));
            CC(U'', vline(c, 1); rounded_corner(c, 1, TOP_LEFT), rounded_corner(c, 1, TOP_RIGHT));
            CC(U'', hline(c, 1); rounded_corner(c, 1, TOP_RIGHT), rounded_corner(c, 1, BOTTOM_RIGHT));
            CC(U'', hline(c, 1); rounded_corner(c, 1, BOTTOM_LEFT), rounded_corner(c, 1, TOP_LEFT));
            CC(U'', vline(c, 1); rounded_corner(c, 1, TOP_LEFT), rounded_corner(c, 1, BOTTOM_RIGHT));
            CC(U'', vline(c, 1); rounded_corner(c, 1, TOP_RIGHT), rounded_corner(c, 1, BOTTOM_LEFT));
            CC(U'', hline(c, 1); rounded_corner(c, 1, TOP_LEFT), rounded_corner(c, 1, BOTTOM_RIGHT));
            CC(U'', hline(c, 1); rounded_corner(c, 1, TOP_RIGHT), rounded_corner(c, 1, BOTTOM_LEFT));
...
#define P(ch, lines)            \
    ...
    S(ch + 1, commit, lines, false);
            ...
            P(U'', RIGHT_EDGE);
            P(U'', LEFT_EDGE);
            P(U'', LEFT_EDGE | RIGHT_EDGE);
            P(U'', BOTTOM_EDGE);
            P(U'', TOP_EDGE);
            P(U'', BOTTOM_EDGE | TOP_EDGE);
            P(U'', RIGHT_EDGE | BOTTOM_EDGE);
            P(U'', LEFT_EDGE | BOTTOM_EDGE);
            P(U'', RIGHT_EDGE | TOP_EDGE);
            P(U'', LEFT_EDGE | TOP_EDGE);
            P(U'', TOP_EDGE | BOTTOM_EDGE | RIGHT_EDGE);
            P(U'', TOP_EDGE | BOTTOM_EDGE | LEFT_EDGE);
            P(U'', LEFT_EDGE | RIGHT_EDGE | BOTTOM_EDGE);
            P(U'', LEFT_EDGE | RIGHT_EDGE | TOP_EDGE);
            P(U'', LEFT_EDGE | RIGHT_EDGE | TOP_EDGE | BOTTOM_EDGE);
#undef P
#define Q(ch, which)                \
...
#undef Q
        ...
        case U'┼' ... U'┼' + 15: cross(c, ch - U'┼'); break;
#define T(q, func) \
    case q ... q + 7: func(c, q, ch - q); break;
            ...
            T(U'┴', horz_t);
#undef T
            C(U'╒', dvcorner, 1, TOP_LEFT);
            C(U'╕', dvcorner, 1, TOP_RIGHT);
            C(U'╘', dvcorner, 1, BOTTOM_LEFT);
            C(U'╛', dvcorner, 1, BOTTOM_RIGHT);
            C(U'╓', dhcorner, 1, TOP_LEFT);
            C(U'╖', dhcorner, 1, TOP_RIGHT);
            C(U'╙', dhcorner, 1, BOTTOM_LEFT);
            C(U'╜', dhcorner, 1, BOTTOM_RIGHT);
            C(U'╔', dcorner, 1, TOP_LEFT);
            C(U'╗', dcorner, 1, TOP_RIGHT);
            C(U'╚', dcorner, 1, BOTTOM_LEFT);
            C(U'╝', dcorner, 1, BOTTOM_RIGHT);
            C(U'╟', dpip, 1, RIGHT_EDGE);
            C(U'╢', dpip, 1, LEFT_EDGE);
            C(U'╤', dpip, 1, BOTTOM_EDGE);
            C(U'╧', dpip, 1, TOP_EDGE);
